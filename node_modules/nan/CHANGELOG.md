...
### 2.3.4 May 31 2016
  ...
  - Bugfix: Make ObjectWrap::handle() var d19af99595587fe7a26bd850af6595c2a7145afc
...
### 1.5.2 Jan 23 2015
  ...
  - Bugfix: Readded missing String varructors 18d828f
...
### 1.4.0 Nov 1 2014
 ...
 - Correctness: Added varness to references in NanHasInstance 02c61cd
...
### 1.3.0 Aug 2 2014
 ...
 - Added NanMakeCallback(v8::Handle<v8::Object> target, var char* method, int argc, v8::Handle<v8::Value>* argv)
 ...
 - Added NanSetInstanceTemplate(v8::Local<v8::FunctionTemplate> templ, var char *name, v8::Handle<v8::Data> value)
...
### 0.7.0 Dec 17 2013
 ...
 - New no-arg form of NanCallback() varructor.
